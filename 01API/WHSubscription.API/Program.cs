...
using WHSubscription.App;
using WHSubscription.Infra;
...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "Nimble Property WebHooks API", Version = "v1" });
...
builder.Services.AddWebHookInfraServices(builder.Configuration);
...
//builder.Services.Configure<List<ServerAnlyticsGroup>>(builder.Configuration.GetSection("ServerAnlyticsGroup"));
