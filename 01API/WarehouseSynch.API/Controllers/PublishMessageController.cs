...
namespace WareHouseSynch.API.Controllers
{
    ...
    [ValidateModel]
    [Authorize]
    public class PublishMessgaeController : ControllerBase
    {
        #region Fields
        ...
        #region Constructor
        public PublishMessgaeController(IOptions<List<ServerAnlyticsGroup>> _serverGroup, ILoggerService _logger, IPublishService _publishService)
        {   
