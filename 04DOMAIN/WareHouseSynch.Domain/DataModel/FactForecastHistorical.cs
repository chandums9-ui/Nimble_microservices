...
[PrimaryKey("ForecastTransId", "PartitionKey")]
[Table("Fact_Forecast_Historical")]
public partial class FactForecastHistorical
{
    [Key]
    [Column("ForecastTransID")]
    public long ForecastTransId { get; set; }
